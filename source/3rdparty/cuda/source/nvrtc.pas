...
var
nvrtcGetErrorString : function(result:nvrtcResult):pchar;
{*********************************************************************** }{*
 *
...
nvrtcVersion : function(major:Plongint; minor:Plongint):nvrtcResult;
{*
 * \ingroup query
...
nvrtcGetNumSupportedArchs : function(numArchs:Plongint):nvrtcResult;
{*
 * \ingroup query
...
nvrtcGetSupportedArchs : function(supportedArchs:Plongint):nvrtcResult;
{*********************************************************************** }{*
 *
...
nvrtcCreateProgram : function(prog:PnvrtcProgram; src:Pchar; name:Pchar; numHeaders:longint; headers:PPchar; 
    includeNames:PPchar):nvrtcResult;
{*
 * \ingroup compilation
...
nvrtcDestroyProgram : function(prog:PnvrtcProgram):nvrtcResult;
{*
 * \ingroup compilation
...
(* Const before type ignored *)
(* Const before declarator ignored *)
nvrtcCompileProgram : function(prog:nvrtcProgram; numOptions:longint; options:PPchar):nvrtcResult;
{*
 * \ingroup compilation
...
nvrtcGetPTXSize : function(prog:nvrtcProgram; ptxSizeRet:Psize_t):nvrtcResult;
{*
 * \ingroup compilation
...
nvrtcGetPTX : function(prog:nvrtcProgram; ptx:Pchar):nvrtcResult;
{*
 * \ingroup compilation
...
nvrtcGetCUBINSize : function(prog:nvrtcProgram; cubinSizeRet:Psize_t):nvrtcResult;
{*
 * \ingroup compilation
...
nvrtcGetCUBIN : function(prog:nvrtcProgram; cubin:Pchar):nvrtcResult;
{*
 * \ingroup compilation
 * \brief   
...
nvrtcGetNVVMSize : function(prog:nvrtcProgram; nvvmSizeRet:Psize_t):nvrtcResult;
{*
 * \ingroup compilation
 * \brief   
 * DEPRECATION NOTICE: This function will be removed in a future release. Please use
...
nvrtcGetNVVM : function(prog:nvrtcProgram; nvvm:Pchar):nvrtcResult;
{*
 * \ingroup compilation
...
nvrtcGetLTOIRSize : function(prog:nvrtcProgram; LTOIRSizeRet:Psize_t):nvrtcResult;
{*
 * \ingroup compilation
...
nvrtcGetLTOIR : function(prog:nvrtcProgram; LTOIR:Pchar):nvrtcResult;
{*
 * \ingroup compilation
...
nvrtcGetOptiXIRSize : function(prog:nvrtcProgram; optixirSizeRet:Psize_t):nvrtcResult;
{*
 * \ingroup compilation
...
nvrtcGetOptiXIR : function(prog:nvrtcProgram; optixir:Pchar):nvrtcResult;
{*
 * \ingroup compilation
...
nvrtcGetProgramLogSize : function(prog:nvrtcProgram; logSizeRet:Psize_t):nvrtcResult;
{*
 * \ingroup compilation
...
nvrtcGetProgramLog : function(prog:nvrtcProgram; log:Pchar):nvrtcResult;
{*
 * \ingroup compilation
...
(* Const before type ignored *)
(* Const before declarator ignored *)
nvrtcAddNameExpression : function(prog:nvrtcProgram; name_expression:Pchar):nvrtcResult;
{*
 * \ingroup compilation
...
(* Const before declarator ignored *)
(* Const before type ignored *)
nvrtcGetLoweredName : function(prog:nvrtcProgram; name_expression:Pchar; lowered_name:PPchar):nvrtcResult;
{*
